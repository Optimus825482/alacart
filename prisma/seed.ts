...
async function main() {
    ...
    data: [
      {
        ...
        defaultNotes: "Sosu Ayrı, Ekstra Balzamik, Zeytinyağlı, Çıtır Ekmek İle",
      ...
      },
      {
        ...
        defaultNotes: "Limonlu, Acısız, Sosu Ayrı, Ekstra Çıtır",
      ...
      },
      {
        ...
        defaultNotes: "Sosu Ayrı, Limonlu, Acısız, Çıtır Ekmek İle",
      ...
      },
      {
        ...
        allergens: "Süt Ürünü",
        defaultNotes: "Sosu Ayrı, İyice Pişmiş, Ekstra Risotto İle",
      ...
      },
      {
        ...
        allergens: "Balık",
        defaultNotes: "Az Pişmiş, İyi Pişmiş, Limonlu, Sosu Ayrı, Kılçıksız",
      ...
      },
      {
        ...
        allergens: "Süt Ürünü",
        defaultNotes: "Al Dente, Bol Parmesanlı, Trüf Yağı İle, Glutensiz",
      ...
      },
      {
        ...
        allergens: "Süt Ürünü",
        defaultNotes: "Şurubu Az, Soğuk Servis, Nanesiz",
      ...
      },
      {
        ...
        defaultNotes: "Dondurmalı, Dondurmasız, Ilık Servis, Bol Çikolatalı",
  ...
  await prisma.menuItem.createMany({
    data: [
      { name: "Roof Sunset Spritz", description: "Aperol, prosecco, greyfurt köpüğü ve taze biberiye", defaultNotes: "Buzlu, Buzsuz, Bol Buzlu, Limon Dilimli, Alkolsüz", categoryId: roofCocktails.id },
      { name: "Merit Signature Smoked Bourbon", description: "Tütsülenmiş meşe dalı, Angostura bitter ve portakal kabuğu", defaultNotes: "Buzlu, Buzsuz, Tek Buz Küpü, Narenciyeli", categoryId: roofCocktails.id },
      { name: "Chablis Premier Cru (Kadeh / Şişe)", description: "Fransız seçkin beyaz şarap", defaultNotes: "Soğuk Servis, Kova İçinde, Kadeh İle", categoryId: roofCocktails.id },
      { name: "Rize Demleme Çay / Espresso", description: "Taze demlenmiş", defaultNotes: "Şekersiz, Az Şekerli, Orta Şekerli, Şekerli, Sıcak Servis", categoryId: roofHotDrinks.id },
      { name: "San Pellegrino Doğal Maden Suyu (750ml)", description: "Limon dilimi ile", defaultNotes: "Buzlu, Buzsuz, Limon Dilimli", categoryId: roofHotDrinks.id },
    ],
  });
    ...
    data: [
      {
        ...
        allergens: "Süt Ürünü",
        defaultNotes: "Sosu Ayrı, Ekstra Parmesan, Balzamik İle",
        imageUrl: "https://images.unsplash.com/photo-1544025162-d76694265947?w=500&auto=format&fit=crop&q=80",
      ...
      },
      {
        ...
        allergens: "Gluten",
        defaultNotes: "Ekstra Kızarmış Ekmek, Sarımsaksız Ekmek",
      ...
      },
      {
        ...
        allergens: "Süt Ürünü",
        defaultNotes: "Az Pişmiş, Orta Az Pişmiş, Orta Pişmiş, Orta İyi Pişmiş, İyi Pişmiş, Sosu Ayrı, Hardal İle",
        imageUrl: "https://images.unsplash.com/photo-1544025162-d76694265947?w=500&auto=format&fit=crop&q=80",
      ...
      },
      {
        ...
        allergens: "Süt Ürünü",
        defaultNotes: "Az Pişmiş, Orta Az Pişmiş, Orta Pişmiş, Orta İyi Pişmiş, İyi Pişmiş, Sosu Ayrı, Kaya Tuzu İle",
        imageUrl: "https://images.unsplash.com/photo-1558030006-450675393462?w=500&auto=format&fit=crop&q=80",
        categoryId: steakMains.id,
      },
      {
        ...
        allergens: "Süt Ürünü",
        defaultNotes: "Orta Az Pişmiş, Orta Pişmiş, Orta İyi Pişmiş, Dilimlenmiş Servis, Sosu Ayrı",
        imageUrl: "https://images.unsplash.com/photo-1558030006-450675393462?w=500&auto=format&fit=crop&q=80",
        categoryId: steakMains.id,
      },
      {
        ...
        allergens: "Süt Ürünü",
        defaultNotes: "Az Pişmiş, Orta Pişmiş, İyi Pişmiş, Sosu Ayrı, Baharatsız",
        imageUrl: "https://images.unsplash.com/photo-1544025162-d76694265947?w=500&auto=format&fit=crop&q=80",
        categoryId: steakMains.id,
      },
      {
        ...
        defaultNotes: "Sosu Ayrı, Dondurmalı, Dondurmasız",
  ...
  await prisma.menuItem.createMany({
    data: [
      { name: "Chianti Classico Riserva DOCG", description: "Meşe fıçıda yıllandırılmış İtalyan kırmızısı", defaultNotes: "Oda Sıcaklığı, Dekante Edilsin, Kadeh İle", categoryId: steakWines.id },
      { name: "Cabernet Sauvignon Reserve", description: "Yoğun gövdeli seçkin kırmızı şarap", defaultNotes: "Oda Sıcaklığı, Dekante Edilsin, Kadeh İle", categoryId: steakWines.id },
      { name: "Macallan 12 Double Cask Single Malt Viski", description: "Buz ve kuru meyveler ile servis", defaultNotes: "Buzlu, Sek (Buzsuz), Tek Küre Buz, Su İlavesi", categoryId: steakWines.id },
      { name: "Geleneksel Türk Kahvesi", description: "Lokum ve su eşliğinde", defaultNotes: "Sade (Şekersiz), Az Şekerli, Orta Şekerli, Şekerli", categoryId: steakWines.id },
    ],
  });
